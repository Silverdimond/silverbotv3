...
namespace SilverCraftBot.Modules
{
    public class Language
    {
        ...
        public string Requested_by { get; set; } = "Requested by "; //"Requested by "SilverDimond

        public string Lang_name { get; set; } = "Default(EN)";
        public string Lang_code_for_useless_facts { get; set; } = "en"; //must be en or de for useless facts
        ...
        public string Joined_before { get; set; } = "Joined "; //"Joined "Testing!
        public string Joined_after { get; set; } = "!"; //Joined Testing"!"
        ...
        public string Time_in_utc { get; set; } = "Time now in UTC is "; //UTC IS GMT YES
            ...
            if (CachedLanguages.Count != 0)
            {
                if (CachedLanguages.ContainsKey(a))
                {
                    if (logging)
                    {
                        ...
                        Console.Write($" huge success loading ");
